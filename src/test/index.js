...
describe('.generate()', function () {
  ...
  it('should generate an account compatible with ICAP Direct', function () {
    var max = new sofUtil.BN('088f924eeceeda7fe92e1f5b0fffffffffffffff', 16)
    var wallet = Wallet.generate(true)
    assert.strictEqual(wallet.getPrivateKey().length, 32)
    assert.strictEqual(new sofUtil.BN(wallet.getAddress()).lte(max), true)
  })
})
...
describe('.fromSophyWallet()', function () {
  ...
  it('should work with encrypted input', function () {
    var sophyWalletEncrypted = '{"address":"0x9d6abd11d36cc20d4836c25967f1d9efe6b1a27c","encrypted":true,"locked":true,"hash":"b7a6621e8b125a17234d3e5c35522696a84134d98d07eab2479d020a8613c4bd","private":"U2FsdGVkX1/hGPYlTZYGhzdwvtkoZfkeII4Ga4pSd/Ak373ORnwZE4nf/FFZZFcDTSH1X1+AmewadrW7dqvwr76QMYQVlihpPaFV307hWgKckkG0Mf/X4gJIQQbDPiKdcff9","public":"U2FsdGVkX1/awUDAekZQbEiXx2ct4ugXwgBllY0Hz+IwYkHiEhhxH+obu7AF7PCU2Vq5c0lpCzBUSvk2EvFyt46bw1OYIijw0iOr7fWMJEkz3bfN5mt9pYJIiPzN0gxM8u4mrmqLPUG2SkoZhWz4NOlqRUHZq7Ep6aWKz7KlEpzP9IrvDYwGubci4h+9wsspqtY1BdUJUN59EaWZSuOw1g=="}'
    var wallet = Thirdparty.fromSophyWallet(sophyWalletEncrypted, 'testtest')
    assert.strictEqual(wallet.getAddressString(), '0x9d6abd11d36cc20d4836c25967f1d9efe6b1a27c')
  })
})

describe('.fromSophyCamp()', function () {
  it('should work with seed text', function () {
    var wallet = Thirdparty.fromSophyCamp('sophycamp123')
    assert.strictEqual(wallet.getAddressString(), '0x44afb164543a1cf20af90d469f6b04f1d73eabd0')
  })
})
...
describe('.fromQuorumWallet()', function () {
  it('should work', function () {
    var wallet = Thirdparty.fromQuorumWallet('testtesttest', 'sophonjs-wallet')
    assert.strictEqual(wallet.getAddressString(), '0xc3e36128000ba7a7f626c0a4f956411bba5cb2ae')
  })
})
